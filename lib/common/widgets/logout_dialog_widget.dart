...
class LogOutDialogWidget extends StatelessWidget {
  ...
  const LogOutDialogWidget({super.key, this.isFailed = false, this.rotateAngle = 0, required this.icon, required this.title,
                ...
                Padding(
                  ...
                  child: Row(
                    children: [
                      ...
                      Expanded(child: CustomButtonWidget(buttonText: onTapTrueText,
                        onPressed: onTapTrue)),
                    ],
                  ),
                ),
