              ...
              child: Column(
                children: [
                  ...
                  Container(
                      width: MediaQuery.of(context).size.width/2,
                      decoration: BoxDecoration(
                      color: order.orderStatus == 'confirmed' ? Theme.of(context).colorScheme.primary.withValues(alpha:.15):
                      order.orderStatus == 'cooking' ? Theme.of(context).primaryColor.withValues(alpha:.15):Theme.of(context).secondaryHeaderColor.withValues(alpha:.15),
