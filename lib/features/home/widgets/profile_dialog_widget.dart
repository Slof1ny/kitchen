...
import 'package:efood_kitchen/common/widgets/custom_image_widget.dart';
          ...
          return Column(
            ...
            children: [
              Padding(
                ...
                child: Container(transform: Matrix4.translationValues(0, -50, 0),
                  ...
                  child: ClipRRect(
                    ...
                    child: CustomImageWidget(
                        ...
                        image: '${Get.find<SplashController>().baseUrls.kitchenProfileUrl}'
                            '/${authController.profileModel.profile!.image}'),
                  ),
                ),
              ),

             Container(transform: Matrix4.translationValues(0, -50, 0),child: Column(children: [
               Text(
